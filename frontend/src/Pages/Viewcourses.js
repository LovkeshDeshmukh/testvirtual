  ...
  return (
    <div>
        ...
        <div style={{width:"82%",marginLeft:"1.5%", height:"100vh", display:"flex", flexDirection:"column"}}>
            ...
            <div style={{height:"70vh", width:"45%", backgroundColor:"white",display:"flex",flexDirection:"column",alignItems:"center",}}>
            ...
            <div style={{height:"20vh", width:"100%", display:"flex", justifyContent:"space-evenly", alignItems:"center", flexDirection:"column"}}>
              ...
              <div style={{height:"12vh", width:"95%", backgroundColor:"whitesmoke",borderRadius:"10px", display:"flex"}}>
                        ...
                        <div style={{height:"12vh", width:"50%",display:"flex",flexDirection:"column",justifyContent:"center"}}>
                            <label style={{fontSize:"19px", fontWeight:"bold",letterSpacing:1,height:25}}>{data.courseName}</label>
                            <label>by {data.teacherName}</label>
                            {/* <VideoCallFrame
            ...
            <div style={{height:"40vh", width:"100%", backgroundColor:"lightgrey", display:"flex", flexDirection:"column", alignItems:"center", borderRadius:10}}>
              <h1>Courses, Teachers Details</h1>
            ...
            <select style={{height:40, width:"70%",border:"none",borderRadius:10,outline:"none"}}>
              ...
              <option>Individual</option>
                ...
                <button style={{height:40, width:"30%", backgroundColor:"black", color:"white",border:"none", borderRadius:10}}>Send Request</button>
            </div>
                   ...
                   <div style={{height:"55vh", width:"45%", backgroundColor:"white",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"space-evenly",}}>
                   <div
