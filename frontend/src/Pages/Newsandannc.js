  ...
  return (
    ...
    <div style={{height:"100vh", width:"100%",display:"flex"}}>
        ...
        <div style={{width:"82%",marginLeft:"1.5%", height:"100vh", display:"flex", flexDirection:"column"}}>
            <Header/>
            <div style={{width:"100%", height:"73vh",backgroundColor:"lightgrey",alignItems:"center",display:"flex",flexDirection:"column",justifyContent:"center",borderRadius:10,overflowY:"auto"}}>
                {newsList.map((i)=>
    ...
    <div style={{width:"100%", height:"73vh",backgroundColor:"lightgrey",alignItems:"center",display:"flex",borderRadius:10,flexDirection:"column",overflowY:"auto",paddingBottom:"10px"}}>
        <div style={{height:"50px", width:"80%", backgroundColor:"white", textAlign:"center", borderRadius:10, marginTop:10}}>
            <h2>News And Announcement</h2>
                ...
                {newsList.map((i)=>
               <div style={{height:"60vh",marginTop:"10px", width:"80%", backgroundColor:"white", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"space-evenly",borderRadius:10}}><br/><br/>
                <h2>{i.heading}</h2>
                <label>{i.description}</label>
                <img style={{height:"40vh", width:"60%"}} src={i.image}/>
               </div>)}
